package com.bob.modules.sysOrgnization.service;
...
/**
 * SysOrgnizationService
 *
 * @author Bob
 * @Date 2016-1-3 22:55:44
 * @since v0.0.1
 */
public interface SysOrgnizationService extends BaseService<SysOrgnization, SysOrgnizationVo> {

...
<body>
	...
	<script src="<%=request.getContextPath()%>/demo/jquery/jquery-1.8.3.js">
		
	</script>

	<script src="<%=request.getContextPath()%>/demo/bootstrap/js/bootstrap.js">
		
	</script>

	<script src="<%=request.getContextPath()%>/demo/datepicker/js/bootstrap-datepicker.js">

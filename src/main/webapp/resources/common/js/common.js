		...
		var that = this,
		    opts = $.extend({
			    		...
			    		success: function (error, element) { 
				    	   ...
				    	   $(element).css("border",$(element).attr("border_bak"));
				    	}
				        ,errorPlacement: function(error, element) {
				        	if($(element).attr("border_bak") == undefined){
				        		$(element).attr("border_bak",element.css("border"));
				        	}
				        	$(element).poshytip('disable'); 
				        	$(element).poshytip('destroy'); 
				        	if (!error.is(':empty')) { 
				        		...
				        		//获取当前的content的滚动条位置
				        		var _contentScroll=$("#content").scrollTop();
				        		$(element).poshytip({ 
